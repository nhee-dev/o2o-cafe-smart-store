...
import com.knhlje.cafe.model.dto.Order;
import com.knhlje.cafe.model.dto.OrderDetail;
...
class OrderTest extends AbstractDaoTest {
	...
	public void selectTest() {
		...
		assertEquals(selected.getUserId(), "ssaf01");
	}
	...
	public void insertTest() {
		Order data = Order.builder().userId("ssaf01").orderTable("order_table_01").build();
	...
	public void selectByUser() {
		List<Order> orders = oDao.selectByUser("ssaf03");
