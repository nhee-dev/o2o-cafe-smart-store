...
import com.knhlje.cafe.model.dto.Comment;
...
class CommentTest extends AbstractDaoTest {
	...
	public void selectTest() {
		...
		assertEquals(comment.getUserId(), "ssaf01");
	...
	public void selectAll() {
		...
		assertEquals(selected.getUserId(), "ssaf10");
	}

	@Test
	@org.junit.jupiter.api.Order(3)
	public void insertTest() {
		Comment comment = new Comment("ssaf01", productId, 5.0, "좋음");
	...
	public void selectAllByProduct() {
		...
		assertEquals(result.get(0).getUserId(), "ssaf01");
	}
